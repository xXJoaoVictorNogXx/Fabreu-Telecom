      ...
      <div className="justify-between flex w-full items-center">
        ...
        <NavigationMenu className="flex justify-between">
          <div className="flex gap-4 items-center">
            ...
            {/* --- INICIO DO DROPDOWN CUSTOMIZADO --- */}
            <div className="relative">
              <button
                onMouseEnter={() => setIsServicesOpen(!isServicesOpen)}
                className={cn(
                  "text-sm font-medium transition-colors hover:text-amber-400 flex items-center gap-1",
                  isServicesOpen ? "text-amber-400" : "text-amber-50"
                )}
              >
                Serviços
                <svg
              ...
              {isServicesOpen && (
                <div className="absolute top-full left-0 mt-2 w-56 bg-white rounded-md shadow-lg p-2 z-50 flex flex-col gap-1">
                  <Link
                    href={"/servicos/internet"}
          ...
          >
            ...
            >
              <path
                ...
                fill={cn(isServicesOpen ? "#f8bc31" : "#ffffff")}
              />
            </svg>
          </Link>
          <Link
            href="https://fabreutelecom.sgp.tsmx.com.br/accounts/central/login"
            target="_blank"
            rel="noopener noreferrer"
